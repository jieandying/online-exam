...
public interface MultiQuestionMapper {
     ...
     * 随机获取指定数量的选择题
     */
    @Select("SELECT * FROM multi_question ORDER BY RAND() LIMIT #{count}")
    List<MultiQuestion> findRandom(@Param("count") Integer count);
    ...
    /** 统计总题数 */
    @Select("SELECT COUNT(*) FROM multi_question")
    int countAll();
}
