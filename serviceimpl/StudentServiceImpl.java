...
public class StudentServiceImpl implements StudentService {
    ...
    public IPage<Student> findAll(
        ...
        return studentMapper.findAllPaged(page, name, grade, tel, institute, major, clazz);
    }
    ...
    @Override
    public int updateFaceData(Integer studentId, String faceData) {
        return studentMapper.updateFaceData(studentId, faceData);
    }
    
    @Override
    public String getFaceData(Integer studentId) {
        return studentMapper.getFaceData(studentId);
    }

    @Override
    public java.util.List<String> findAllClazz() {
