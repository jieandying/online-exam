...
//    分页
    ...
    /**
     * 查看某次考试的详细答卷（用于考后错题解析）
     */
    @GetMapping("/score/detail/{examCode}/{studentId}")
    public ApiResult getExamDetail(@PathVariable("examCode") Integer examCode,
                                   @PathVariable("studentId") Integer studentId) {
        return ApiResultHandler.buildApiResult(200, "查询成功",
            scoreService.getExamDetail(examCode, studentId));
    }
}
